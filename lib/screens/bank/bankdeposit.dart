...
class _BankDepositState extends State<BankDeposit> {
  ...
  Future<void> fetchCustomerAccounts() async {
    final agentUrl =
        "https://fnetagents.xyz/get_customer_account/${_customerPhoneController.text}/";
  ...
  Future<void> fetchCustomerBankAndNames(String deBank) async {
    try {
      final customerAccountUrl =
          "https://fnetagents.xyz/get_customer_accounts_by_bank/${_customerPhoneController.text}/$deBank";
  ...
  Future<void> processBankDeposit() async {
    ...
    if (res.statusCode == 201) {
      ...
      if (companyName == "Fnet Enterprise") {
        sendSms.sendMySms(num, "FNET",
            "Your deposit of ${_amountController.text.trim()} into your $_currentSelectedBank by ${profileController.companyName} was successful.For more information please call ${profileController.companyNumber}. Thank you for working with Easy Agent.");
      } else {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      readOnly: true,
                                      decoration:
                                          buildInputDecoration("Account Name"),
                        ...
                        isCustomer && isAccountNumberAndName
                            ? Padding(
                                padding: const EdgeInsets.only(bottom: 10.0),
                                child: TextFormField(
                                  onChanged: (value) {

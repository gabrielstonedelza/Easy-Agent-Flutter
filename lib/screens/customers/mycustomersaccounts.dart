...
class MyCustomersAccounts extends StatefulWidget {
  final phone_number;
  const MyCustomersAccounts({Key? key,required this.phone_number}) : super(key: key);

  @override
  State<MyCustomersAccounts> createState() => _MyCustomersAccountsState(phone_number:this.phone_number);
}
...
class _MyCustomersAccountsState extends State<MyCustomersAccounts> {
  ...
  Future<void> getAllMyCustomersAccounts(String token) async {
    final url = "https://fnetagents.xyz/customer_accounts_details_by_phone_number/$phone_number/";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ? const LoadingUi()
          : ListView.builder(
          itemCount: allMyCustomersAccounts != null ? allMyCustomersAccounts.length : 0,
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    buildRow("Bank : ", "bank"),
                    Padding(
                      padding: const EdgeInsets.only(left: 8.0, top: 2,bottom: 10),
                      child: Row(
                        children: [
                          const Text(
                            "Date: ",

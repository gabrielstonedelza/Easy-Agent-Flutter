...
class _DashboardState extends State<Dashboard> {
  ...
  void initState(){
    ...
    localNotificationManager.setOnShowNotificationReceive(onNotificationReceive);
  }
            ...
            children: [
              ...
              DefaultTextStyle(
                ...
                child: Container(
                  ...
                  child: const Text('App created by Havens Software Development'),
                ),
              ),
            ],
          ),
                ...
                children: [
                  GetBuilder<NotificationController>(builder:(controller){
                    return badges.Badge(
                      ...
                      showBadge: true,
                      badgeContent:
                      Text(controller.notificationsUnread.length.toString(),style:const TextStyle(color:defaultWhite)),
              ...
              children: [
                Expanded(
                  child: GestureDetector(
                    child: Column(
                      children: [
                        Image.asset("assets/images/group.png",width: 70,height: 70,),
                        const SizedBox(height: 10,),
                        const Text("Customer"),
              ...
              children: [
                Expanded(
                  child: GestureDetector(
                    child: Column(
                      children: [
                        Image.asset("assets/images/cash-payment.png",width: 70,height: 70,),
                        const SizedBox(height: 10,),
                        const Text("Payment"),
                      ],
                    ),
                ...
                Expanded(
                  child: GestureDetector(
                    child: Column(
                      children: [
                        Image.asset("assets/images/law.png",width: 70,height: 70,),
                        const SizedBox(height: 10,),
                ...
                Expanded(
                  child: GestureDetector(
                    child: Column(
                      children: [
                        Image.asset("assets/images/exchanging.png",width: 70,height: 70,),
                        const SizedBox(height: 10,),
                        const Text("Floats"),
                      ],
                    ),
              ...
              children: [
                ...
                Expanded(
                  child: GestureDetector(
                    child: Column(
                      children: [
                        Image.asset("assets/images/fraud-alert.png",width: 70,height: 70,),
                        const SizedBox(height: 10,),
                        const Text("Fraud"),
                      ],
                    ),
                ...
                Expanded(
                  child: GestureDetector(
                    child: Column(
                      children: [
                        Image.asset("assets/images/groupchat.png",width: 70,height: 70,),
                        const SizedBox(height: 10,),
                        const Text("Chat"),
                      ],
                    ),
